    ...
    <div className="h-full w-full p-4 md:p-8 pb-32 overflow-y-auto relative">
      ...
      <div className="flex justify-end mb-6 relative z-50 mt-[-4rem]">
        <div className="flex items-center">
          <div className={`flex items-center gap-2 overflow-hidden transition-all duration-500 ease-out origin-right ${isActionMenuOpen ? 'max-w-[600px] opacity-100 pr-2' : 'max-w-0 opacity-0 pr-0'}`}>
      ...
      {showCarbonModal && <CarbonStatsModal onClose={() => setShowCarbonModal(false)} />}
