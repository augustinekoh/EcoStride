...
import { ChevronLeft, User, Bell, Lock, Sliders, HelpCircle, MessageSquare, LogOut, ChevronRight, Moon, Sun } from 'lucide-react';
...
export const SettingsView: React.FC = () => {
  ...
  return (
    <div className="h-full w-full p-4 md:p-8 pb-32 overflow-y-auto relative bg-brand-cream transition-colors duration-500">
